              ...
              <Suspense fallback={<LoadingScreen />}>
                <Switch>
                  ...
                  <Route
                    ...
                    component={lazy(() =>
                      import('src/views/docs/DeploymentView')
                    )}
                  />
                  <Route
                    exact
                    path="/docs/api-calls"
                    component={lazy(() =>
                      import('src/views/docs/ApiCallsView')
                    )}
                  />
                  <Route
                    exact
                    path="/docs/analytics"
                    component={lazy(() =>
                      import('src/views/docs/AnalyticsView')
                    )}
                  />
                  <Route
                    exact
                  ...
                  <Route
                    ...
                    path="/docs/settings"
                    component={lazy(() =>
                      import('src/views/docs/SettingsView')
                    )}
                  />
                  <Route
                    exact
                  ...
                  <Route
                    ...
                    path="/docs/changelog"
                    component={lazy(() =>
                      import('src/views/docs/ChangelogView')
                    )}
                  />
                  <Redirect to="/404" />
                </Switch>
